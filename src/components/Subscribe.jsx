...
const IterateFlex = IterateWrapper(Flex, {
  "data-iterate": "eyJldmVudHMiOlt7Im5hbWUiOiJzdWJzY3JpYmVfY2xpY2tlZCIsImF0dHJpYnV0ZXMiOnsiTG9jYXRpb24iOiJTdWJzY3JpYmUiLCJkYXRlIjoiQ2FsbEV4cHJlc3Npb24ifX1dLCJmaWxlUGF0aCI6InNyYy9jb21wb25lbnRzL1N1YnNjcmliZS5qc3giLCJpZCI6ImNlNmNjZjYxLTEzYTEtNDhiYS05M2UzLTZiODU5MjYzYTkzMCJ9"
});
      ...
      <Container maxW="1140px">
        ...
        xl: "0"
          ...
          <Stack gap="20px">
            ...
            <form data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiMzg3ZmVmNWQtZDdlYy00ODBkLTgxOTYtZmFmZTRiNTNkZTU3IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9TdWJzY3JpYmUuanN4In0=">
              <Text as="label" color="var(--darkTextColor2)">
                Email
              </Text>
              <IterateFlex my="20px">
                <input type="text" className="applyInput" placeholder="Your working email" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiYmM2YTliYzUtYjY5Zi00NDk3LWE4MGMtODg3OWQ1NmRmYWY4IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9TdWJzY3JpYmUuanN4In0=" />
