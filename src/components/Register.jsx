...
export default function Register({
  ...
  return <Stack px="40px" overflow="scroll">
      ...
      <form data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiOTMzYTM0ZjYtZGVjMS00ZTVlLWI0OGUtNGIxMGM3NDdhMWJmIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==">
        <Stack gap="16px" pb="8px" borderBottom="1px solid var(--lightBorderColor)">
          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Full Name
          </Text>
          <input type="text" className="loginInput" placeholder="Your full name" fontSize="12px" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiNjA4MDVkZmItMjI1OS00NWRmLWE0OGEtNzc3OWYyNDkwZDA4IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==" />
          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Email
          </Text>
          <input type="text" className="loginInput" placeholder="Your working email" fontSize="12px" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiMTFiZDMxMzMtZTQ4MC00ZTQxLTk0OWQtN2Q1OTkyOGY4OGI5IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==" />

          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Password
          </Text>
          <input type="password" className="loginInput" placeholder="Password" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiNTczYzBiMWYtOGRmZS00MDBlLThjYmItN2IyMDM1MzVjNTQ2IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==" />
          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Confirm Password
          </Text>
          <input type="password" className="loginInput" placeholder="Password" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiYmVhZWFiN2MtOThlMC00ZGMzLTk3ZjEtYjVhOWU5Y2Y2N2U2IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==" />
