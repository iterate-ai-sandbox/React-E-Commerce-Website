...
export default function Register({
  ...
  return <Stack px="40px" overflow="scroll">
      ...
      <form data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiZTY0NWZjZTMtMzljNy00MTkyLWE5M2ItZjk5ZTExMTM5OGJiIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==">
        <Stack gap="16px" pb="8px" borderBottom="1px solid var(--lightBorderColor)">
          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Full Name
          </Text>
          <input type="text" className="loginInput" placeholder="Your full name" fontSize="12px" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiYjc2ZWJmYWQtZmQ0My00M2JkLWIyOTctNWU4ODVjMmU3NDAwIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==" />
          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Email
          </Text>
          <input type="text" className="loginInput" placeholder="Your working email" fontSize="12px" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiNDU4NjA4MjItMTY2YS00Njg2LWIyYWMtMjg0ZWZhZDA1ZjRkIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==" />

          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Password
          </Text>
          <input type="password" className="loginInput" placeholder="Password" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiYzFmMWY2OWUtMzUyOS00OTVkLWE5ZWItM2ZiZTg4MGFlMDllIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==" />
          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Confirm Password
          </Text>
          <input type="password" className="loginInput" placeholder="Password" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiYjI0ODNkNTktY2VmMi00ZWNkLWI4NTctNGU3MTkyNWZiODU4IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9SZWdpc3Rlci5qc3gifQ==" />
