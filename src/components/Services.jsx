...
export default function Services() {
  ...
  return <Container maxW="1140px">
      ...
      md: "center",
      lg: "space-between"
    }} py="40px" wrap="wrap" gap={{
      base: "20px",
      md: "30px",
      lg: "0"
    }}>
        {servicesData.map((item, id) => <Stack key={id} gap="20px" py="70px" px="20px" boxShadow=" rgba(149, 157, 165, 0.2) 0px 8px 24px" _hover={{
        ...
        cursor: "pointer"
            ...
            <Text fontSize="20px" lineHeight="30px" fontWeight="700" color="var(--darkBgColor)">
              {item.title}
            </Text>
