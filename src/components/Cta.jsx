...
export default function Cta() {
  return <Box bg="var(--darkBgColor)" py="40px" pb={{
    base: "80px",
    md: "40px",
    xl: "40px"
  }}>
      <Container maxW="1140px">
        ...
        xl: "row"
          ...
          <Stack gap="60px" justify="center" align={{
          base: "center",
          md: "start",
          xl: "start"
        }}>
            <Text fontSize="32px" lineHeight="42px" fontWeight="700" color="var(--light)" textAlign={{
            base: "center",
            md: "start",
            xl: "start"
          }}>
