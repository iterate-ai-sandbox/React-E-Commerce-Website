  ...
  return <Container maxW="1140px">
      ...
      xl: "0"
        ...
        xl: "start"
          ...
          <Text fontSize="46px" lineHeight="60px" color="var(--darkBgColor)" fontWeight="900">
            @createx_store
          </Text>
          <Flex justify="center" align="center" gap="4px" p="14px" color="var(--primary)" border="1px solid var(--primary)" borderRadius="4px" mt="40px" maxW="242px" fontSize="14px" fontWeight="500" _hover={{
          bg: "var(--primary)",
          color: "var(--light)",
          transition: "0.8s"
        }}>
