  ...
  var settings = {
    ...
    appendDots: dots => {
      return <ul style={{
        margin: "0px",
        color: "red"
      }} data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiMzI3N2QwNWYtNjc3Ny00ZTdjLWExY2ItODZmZjI3NmM4NWM5IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ob21lL0JyZW5kcy5qc3gifQ==">{dots}</ul>;
    },
    responsive: [{
      breakpoint: 1024,
      settings: {
