...
export default function Brends() {
  var settings = {
    ...
    appendDots: dots => {
      return <ul style={{
        margin: "0px",
        color: "red"
      }} data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiNzFiMGRkMDktNzU2Ni00MWYzLWIyMTQtNjc2ZTRiNjMzZDFlIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ob21lL0JyZW5kcy5qc3gifQ==">{dots}</ul>;
    },
    responsive: [{
      breakpoint: 1024,
      settings: {
  ...
  return <Box py="20px" my="60px">
      <Container maxW="1140px">
        <Slider {...settings} backgroundColor="blue">
          {brendsData.map(item => {
          return <Flex key={item.id} w="full" h="full" align="center" justify="center">
