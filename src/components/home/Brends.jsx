  ...
  var settings = {
    ...
    appendDots: dots => {
      return <ul style={{
        margin: "0px",
        color: "red"
      }} data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiMzAyM2YyYTItYTJiNS00MjJjLThiODEtNTZlOTQ1YTE0MmNjIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ob21lL0JyZW5kcy5qc3gifQ==">{dots}</ul>;
    },
    responsive: [{
      breakpoint: 1024,
      settings: {
