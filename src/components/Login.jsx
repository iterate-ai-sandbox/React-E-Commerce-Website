...
export default function Login({
  ...
  return <Stack px="40px">
      ...
      <form data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiOTNlYTE1Y2MtY2FhNi00NjhkLTg5ZmQtZmJlZDI4YmM4YmY5IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9Mb2dpbi5qc3gifQ==">
        <Stack gap="16px" pb="8px" borderBottom="1px solid var(--lightBorderColor)">
          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Email
          </Text>
          <input type="text" className="loginInput" placeholder="Your working email" fontSize="12px" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiNDVhNDI2OWUtZTE4YS00ZDM5LWFhNTItNjUwOTlhYmNlMTU4IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9Mb2dpbi5qc3gifQ==" />

          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Password
          </Text>
          <input type="password" className="loginInput" placeholder="Password" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiOGE3NGNjNDQtMDZlMi00ZGZmLTg5M2UtOGNiYWFmM2QzNTQ5IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9Mb2dpbi5qc3gifQ==" />
