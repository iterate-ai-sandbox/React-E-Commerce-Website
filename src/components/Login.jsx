...
export default function Login({
  ...
  return <Stack px="40px">
      ...
      <form data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiM2I1ZjU1ODktODYxMi00MWEwLThiOTYtNjUyOGE0NTM2MGJmIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9Mb2dpbi5qc3gifQ==">
        <Stack gap="16px" pb="8px" borderBottom="1px solid var(--lightBorderColor)">
          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Email
          </Text>
          <input type="text" className="loginInput" placeholder="Your working email" fontSize="12px" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiYzA5NjAwZDQtNWU2OC00MjY3LTgwMWQtODAyNmExNmVmODc0IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9Mb2dpbi5qc3gifQ==" />

          <Text as="label" color="var(--darkTextColor2)" fontSize="14px">
            Password
          </Text>
          <input type="password" className="loginInput" placeholder="Password" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiODhiOTMyZDctZGY3Ni00ZGFkLWE4ZjctZDhkYmEzZjEyNjE1IiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9Mb2dpbi5qc3gifQ==" />
