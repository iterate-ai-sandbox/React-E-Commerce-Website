...
export default function Tags() {
  return <Flex justify="space-between" pb="40px" mt="40px" borderBottom="1px solid var(--lightBorderColor2)" flexDirection={{
    base: "column",
    md: "row",
    xl: "row"
  }} gap={{
    ...
    xl: "0"
      ...
      xl: "row"
        ...
        <Flex wrap="wrap" gap="10px">
          <Text as="span" fontWeight="700" color="var(--lightTextColor3)" border="1px solid var(--lightBorderColor2)" borderRadius="4px" px="20px" py="8px" _hover={{
          bg: "var(--primary)",
          color: "var(--light)",
          transition: "0.8s"
        }}>
