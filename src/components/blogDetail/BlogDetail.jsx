...
export default function BlogDetail() {
  ...
  if (!blog) {
    return <div data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiZjI3OTY0NWItNTdlZi00OTA0LWI1NGYtMWY2ODc3ZWQwZjgzIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">Blog not found.</div>;
  }
  return <>
      <Container maxW="1140px">
        <Stack mt="40px">
          ...
          <Box color="var(--darkTextColor2)">
            ...
            <ul data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiZWRiNjU4MDgtMGY5NS00MjcwLWFmZGEtMzY5ZWE3MGZmYTlkIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
              <li data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiOGY4MzUxNjUtMWRjNi00Yzc2LTkzYWQtZGQ3YTdlNmRhMDUxIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
              ...
              <li data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiNjdiY2IwZmYtMTk0Yy00MzU2LThiYzAtYmVkZDZmZTI4MDAxIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
                <Flex gap="12px" align="center" my={1}>
                  <Box>
                    <Image src={checkIcon} />
                  </Box>
              ...
              <li data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiOWQ5MGU1OGYtZjg4Zi00YTk3LWJlNzMtNDg1YWYxY2RiNzZkIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
                <Flex gap="12px" align="center" my={1}>
                  <Box>
                    <Image src={checkIcon} />
                  </Box>
              ...
              <li data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiNTkxNTlhZWQtNzdiMy00ZWQ5LWE4ODAtZjEzY2ZmMTUxOTFjIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
                <Flex gap="12px" align="center" my={1}>
                  <Box>
                    <Image src={checkIcon} />
                  </Box>
