...
export default function BlogDetail() {
  ...
  if (!blog) {
    return <div data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiZWY5NTVkNjgtYTg3Mi00ZjQ2LThlNjMtMzBkN2MyOGVhOGZhIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">Blog not found.</div>;
  }
  return <>
      <Container maxW="1140px">
        <Stack mt="40px">
          ...
          <Box color="var(--darkTextColor2)">
            ...
            <ul data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiZTMzZmYyMGEtZmYwOC00ODNiLWE2YTMtM2RhODgxOGE1ODNkIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
              <li data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiMmZhNzI1OTEtNzU0MC00ODI0LWE0ZDYtYjRkOGNmYzczZmNiIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
              ...
              <li data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiNmMzOTExMjQtNzkxYi00MTY5LWIwYzMtZGJmNGQzYTQ2MjdkIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
                <Flex gap="12px" align="center" my={1}>
                  <Box>
                    <Image src={checkIcon} />
                  </Box>
              ...
              <li data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiMTJkNDYzOGQtN2Y1MS00NzQwLThmMDgtMDE3NGRlZWQ3ODNiIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
                <Flex gap="12px" align="center" my={1}>
                  <Box>
                    <Image src={checkIcon} />
                  </Box>
              ...
              <li data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiMThmZmEzZWUtYjg0ZC00ZDlkLTkxMDMtZGZiNmQ3M2Q1YjgyIiwiZmlsZVBhdGgiOiJzcmMvY29tcG9uZW50cy9ibG9nRGV0YWlsL0Jsb2dEZXRhaWwuanN4In0=">
                <Flex gap="12px" align="center" my={1}>
                  <Box>
                    <Image src={checkIcon} />
                  </Box>
