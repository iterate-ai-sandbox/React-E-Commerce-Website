...
const IterateBlogItem = IterateWrapper(BlogItem, {
  "data-iterate": ""
});
      ...
      <Container maxW="1140px">
        ...
        xl: "0"
          ...
          <Flex p="10px" border="1px solid var(--lightBorderColor2)" justify="space-between" align="center" minW="340px">
            <input type="text" placeholder="Search the blog..." className="searchInput" data-iterate="eyJldmVudHMiOm51bGwsImlkIjoiZDYzZDZjYjQtYzI2OS00MTFhLTg2ZDItMWQwZGNjMWVhMjkwIiwiZmlsZVBhdGgiOiJzcmMvcGFnZXMvQmxvZy5qc3gifQ==" />
            <Text as="span" _hover={{
            cursor: "pointer"
          }}>
              <BiSearch />
